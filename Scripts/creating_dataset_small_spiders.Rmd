...
ESTO SE ARREGLÓ CUANDO SE MEZCLARON DATASETS EN ENERO 2026, NO HACE FALTA ELIMINAR LAS SIETE FILAS.
...
Now, we want to keep data from January 2020 to June 2026 (indico 2026 porque quiero mantener todo) 
...
```{r}
maximo <- length(levels(final_ds2_p$data_entry_person))
